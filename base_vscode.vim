...
nnoremap <silent> <C-S-d> :split main.go<cr>
...
nnoremap <silent> <C-0> :call VSCodeNotify('workbench.action.focusSideBar')<CR>
xnoremap <silent> <C-0> :call VSCodeNotify('workbench.action.focusSideBar')<CR>
